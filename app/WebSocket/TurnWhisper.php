...
class TurnWhisper extends WebSocketWhisper {
    ...
    public function process($data): array {
        ...
        // $moduleSeederData = new Data($this->user, [
        //     'api_id' => $game->game,
        //     'bet' => $game->wager,
        ...
        // $server_seed = (new ModuleSeeder($api_game, $game->demo, $moduleSeederData, $game))->find(function(ProvablyFairResult $result) use($api_game, $game, $data) {
